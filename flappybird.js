...
context.fillText("FLAPPY BIRD", 85, boardHeight / 2 - 100); 

context.fillStyle = "black";
context.font = "bold 18px sans-serif";
context.fillText("By Sachi Devnani and Crystal Hooi", 28, boardHeight / 2 - 50);

context.fillStyle = "pink";
context.font = "bold 18px sans-serif";
context.fillText("By Sachi Devnani and Crystal Hooi", 30, boardHeight / 2 - 51);
